                    ...
                    <form method="post" action="<?= route_to('register') ?>" class="mt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" value="<?= old('username') ?>" name="username" class="form-control" id="email" placeholder="johndoe" autofocus="">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="<?= old('email') ?>" name="email" class="form-control" placeholder="example@company.com" id="email" autofocus="">
                            </div>
                        </div>
                        <!-- End of Form -->
