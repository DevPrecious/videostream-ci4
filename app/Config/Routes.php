...
$routes->group('dashboard', ['filter' => 'auth:web'], function ($routes) {
    $routes->match(['get', 'post'], '/', 'Home::dashboard');
    $routes->get('confirm', 'Home::confirm', ['filter' => 'confirm']);
});

$routes->match(['get', 'post'], '/profile/(:num)', 'Profile::index/$1', ['filter' => 'auth:web']);
$routes->match(['get', 'post'], '/edit/(:num)', 'Profile::edit/$1', ['filter' => 'auth:web']);
$routes->match(['get', 'post'], '/delete/(:num)', 'Profile::delete/$1', ['filter' => 'auth:web']);
$routes->match(['get', 'post'], '/myvideos', 'Profile::videos', ['filter' => 'auth:web']);
